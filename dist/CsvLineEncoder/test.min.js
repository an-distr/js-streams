import{CsvLineEncoder as o}from"./CsvLineEncoder.min.js";const p=e=>new ReadableStream({start(s){s.enqueue(e),s.close()}}),a=()=>new TransformStream({transform(e,s){console.log(e),s.enqueue(e)}}),r=()=>new WritableStream,n=[{a:1,b:2,c:`aaa
