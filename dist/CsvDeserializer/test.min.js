import{CsvDeserializer as m}from"./CsvDeserializer.min.js";import{SimplePerformanceStreamBuilder as f}from"../PerformanceStream/PerformanceStream.min.js";import{sleep as w}from"../funcs/sleep/sleep.min.js";const i=e=>new ReadableStream({start(o){for(const s of e)o.enqueue(s);o.close()}}),h=()=>new TransformStream({transform(e,o){console.log(e),o.enqueue(e)}}),p=()=>new WritableStream,u=e=>new m(e),c=['a,1,"b,2\\""',"c,3,d,4",`e,5,f
