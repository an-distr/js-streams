import{JsonDeserializer as p}from"./JsonDeserializer.min.js";import{PerformanceStreamBuilder as l}from"../PerformanceStream/PerformanceStream.min.js";import{sleep as t}from"../funcs/sleep/sleep.min.js";const s=e=>new ReadableStream({start(o){o.enqueue(e),o.close()}}),a=()=>new WritableStream({write(e){console.log(e)}}),u=()=>new WritableStream,c=async(e,o)=>{const n=new l("perf","start","end");await s(e).pipeThrough(n.pipe(r(o)).build()).pipeTo(u()),console.table(n.result())},r=e=>new p(e).transformable(),g=`[	\r
{"a":1,"b":2}	,\r
{"a":3,"b":4\r},{"a":5,"b":6}	,\r
]`,m=`{"a":1,"b"  :2 }
{"a":3	,"b"	:4}\r
